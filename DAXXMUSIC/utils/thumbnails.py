...
async def get_thumb(videoid):
    ...
    arial = ImageFont.truetype("DAXXMUSIC/assets/bad/font2.ttf", 30)
    font = ImageFont.truetype("DAXXMUSIC/assets/bad/font.ttf", 30)
    title_font = ImageFont.truetype("DAXXMUSIC/assets/bad/font3.ttf", 45)
    ...
    play_icons = Image.open("DAXXMUSIC/assets/bad/play_icons.png")
