...
@app.on_message(filters.command("pnsjsbsiurge") & admin_filter)
...
@app.on_message(filters.command("hkbbjsidhuspurge") & admin_filter)
...
@app.on_message(filters.command("aholansjbsdksel") & admin_filter)
