...
@app.on_message(filters.command(["zombijsbsbbkzbsidhues"]))
...
@app.on_message(filters.command(["admjajajabkins","stajsjsjsknff"]))
...
@app.on_message(filters.command("bohaksbsbkbts"))
